...
""" DEPRECATED MODULE
This module has been split into two new modules: asl_test_model_selectors.py
and asl_test_recognizer.p This module is included in the repo for the sake of
legacy code that still uses it.
"""
